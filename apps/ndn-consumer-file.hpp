...
#ifndef NDN_CONSUMERFILE_H
#define NDN_CONSUMERFILE_H
...
public:
  typedef void (*LastRetransmittedInterestDataDelayCallback)(Ptr<App> app, ns3::ndn::Name seqno, Time delay, int32_t hopCount);
...
protected:
  ...
  bool if_first;                 ///< \brief variable to change the condition
  int tellg=0;              ///< \brief to save the position of tellg 
  ...
  //TracedCallback<Ptr<App> /* app */, ns3::ndn::Name /* seqno */, Time /* delay */, int32_t /*hop count*/>
    //m_lastRetransmittedInterestDataDelay;
